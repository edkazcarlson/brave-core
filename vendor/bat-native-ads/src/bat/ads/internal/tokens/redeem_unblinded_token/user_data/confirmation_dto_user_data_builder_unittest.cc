...
bool IsValidUserDataDictionary(const base::Value user_data) {
  ...
  const std::string* platform =
      user_data_dictionary->FindStringKey("platform");
...
TEST_F(BatAdsConfirmationDtoUserDataTest,
       BuildWithoutConversion) {
  // Arrange
...
TEST_F(BatAdsConfirmationDtoUserDataTest,
  ...
  dto::user_data::Build(creative_instance_id, confirmation_type,
    ...
    bool is_valid = IsValidUserDataDictionary(user_data_dictionary->Clone());
